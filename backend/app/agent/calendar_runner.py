"""Runner for the calendar agent.

This module provides utilities for running the calendar agent.
"""
...
def get_calendar_runner() -> Runner:
    """Get or create a Runner instance for the calendar agent."""
...
def run_calendar_agent_message(user_id: str, session_id: str, message: str) -> list[dict]:
    """Run the calendar agent with a message and return serialized events.
